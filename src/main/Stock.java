...
public class Stock {
    ...
    public static void simpleStock() throws IOException {
        ...
        Learning<SimpleToyState, Integer, DiscreteSpace, IDQN> dql =
        		new QLearningDiscreteDense<>(mdp, STOCK_NET, STOCK_QL, manager);
    ...
    public static void stockAsyncMultiThread() throws IOException {
        ...
        AsyncNStepQLearningDiscreteDense dql = 
        		new AsyncNStepQLearningDiscreteDense<>(mdp, STOCK_NET, STOCK_ASYNC_MULTI_THREAD_QL, manager);
