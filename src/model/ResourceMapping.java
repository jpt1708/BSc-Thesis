			...
			while(itr.hasNext()){
				 ...
				 if(aug_ID == ((Node)entry.getValue()).getId()) {
				 	if (((Node)entry.getKey()) instanceof VirtualMachine)  {
				 		((Server)subNode).setCpu( (int) (((Server)entry.getValue()).getCpu()-((VirtualMachine)entry.getKey()).getCpu()));
	...
	public void releaseNodes(Substrate sub){
		...
		while(itr_sub.hasNext()){
			...
			while(itr.hasNext()){
				 ...
				 if(aug_ID == ((Node)entry.getValue()).getId()) {
				 	if (((Node)entry.getKey()) instanceof VirtualMachine  )  {
				    	 ((Server)subNode).setCpu( (int) (((Server)subNode).getCpu()+((VirtualMachine)entry.getKey()).getCpu()));
