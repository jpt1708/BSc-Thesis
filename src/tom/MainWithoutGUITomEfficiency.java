...
public class MainWithoutGUITomEfficiency {
    ...
    public static void main(String[] args) throws CloneNotSupportedException {
        ...
        for (int i = 0; i < experiments; i++) {
            try {
                ...
                requests = MainWithoutGUITom.createFG(10000, false, false);
               ...
               try {
                   MainWithoutGUITom.launchSimulation(simulation, i, "results_efficiency_512_false", false);
               } catch (Exception e) {
                   e.printStackTrace();
               }
               ...
               tom.model.SimulationNFV simulation1 = new tom.model.SimulationNFV(InPs, substrates1, request_tab1, algorithm1);
                try {
                    MainWithoutGUITom.launchSimulation(simulation1, i, "results_efficiency_512_false", false);
                } catch (Exception e) {
                    e.printStackTrace();
                }
                ...
                try {
                    MainWithoutGUITom.launchSimulation(simulation2, i, "results_efficiency_milp_3", false);
                } catch (Exception e) {
                    e.printStackTrace();
                }
